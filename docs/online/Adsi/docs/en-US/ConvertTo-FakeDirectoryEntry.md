...
ConvertTo-FakeDirectoryEntry [[-DirectoryPath] <String>] [[-SID] <String>] [[-Description] <String>]
 ...
 [[-NameBlockList] <Hashtable>] [<CommonParameters>]
```
...
[https://IMJLA.github.io/Adsi/docs/en-US/ConvertTo-FakeDirectoryEntry](https://IMJLA.github.io/Adsi/docs/en-US/ConvertTo-FakeDirectoryEntry)
